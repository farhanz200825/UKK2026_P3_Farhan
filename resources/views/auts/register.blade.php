...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/pages/register-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Sep 2025 12:15:31 GMT -->
<head>
      ...
      <div class="auth-wrapper v2">
        <div class="auth-sidecontent">
          <div class="d-flex align-items-center w-100 justify-content-center">
            <div class="col-md-8">
              <h1 class="text-white mb-5">Sign up in Admindek</h1>
              <p class="text-white"
