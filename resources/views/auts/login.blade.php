...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/pages/login-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Sep 2025 12:15:29 GMT -->
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <div class="auth-main" style="background-image: url(../assets/images/authentication/img-auth-bg-2.jpg)">
        <div class="auth-wrapper v2">
            <div class="auth-sidecontent">
                <div class="d-flex align-items-center w-100 justify-content-center">
                    <div class="col-md-8">
                        <h1 class="text-white mb-5">Login in Admindek</h1>
                        <p class="text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                            dummy text ever.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/login') }}">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ route('dashboard') }}" class="btn btn-primary shadow px-sm-4">Login</a>
                            </div>
                        </form>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/pages/login-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Sep 2025 12:15:30 GMT -->
