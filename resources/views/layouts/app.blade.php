            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item {{ request()->routeIs('pengaduan*') ? 'active' : '' }}">
                        <a href="{{ route('pengaduan') }}" class="pc-link">
                            <span class="pc-micon">
                                <i class="ph ph-warning-octagon"></i>
                            </span>
                            <span class="pc-mtext">Data Pengaduan</span>
                            <span class="pc-mbadge badge bg-success">12</span>
                        </a>
                    </li>

                    <!-- Data Sarana -->
                    <li class="pc-item {{ request()->routeIs('sarana*') ? 'active' : '' }}">
                        <a href="{{ route('sarana') }}" class="pc-link">
                            <span class="pc-micon">
                    ...
                    <!-- Data Ruangan -->
                    <li class="pc-item {{ request()->routeIs('ruangan*') ? 'active' : '' }}">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item">
                                <a class="pc-link" href="#">Furniture</a>
                            </li>
                            <li class="pc-item">
                                <a class="pc-link" href="#">Elektronik</a>
                            </li>
                            <li class="pc-item">
                                <a class="pc-link" href="#">Fasilitas</a>
                            </li>
                            <li class="pc-item">
                                <a class="pc-link" href="#">Infrastruktur</a>
                            </li>
                        </ul>
                    </li>

                    <li class="pc-item pc-caption">
                        <label>Laporan & Statistik</label>
                    ...
                    <!-- Statistik -->
                    <li class="pc-item {{ request()->routeIs('statistik*') ? 'active' : '' }}">
                        <a href="#" class="pc-link">
                            <span class="pc-micon">
                    ...
                    <!-- Rekapitulasi -->
                    <li class="pc-item {{ request()->routeIs('rekapitulasi*') ? 'active' : '' }}">
                        <a href="#" class="pc-link">
                            <span class="pc-micon">
              ...
              <div class="setting-control">
                <div class="image-toggle-group">
                  <button class="image-toggle active" data-value="true" onclick="layout_caption_change('true');" data-bs-toggle="tooltip" title="Show Captions">
                    <img src="{{ asset('assets/images/customizer/caption-on.svg') }}" alt="Caption On" class="toggle-preview">
                  ...
                  <button class="image-toggle" data-value="false" onclick="layout_caption_change('false');" data-bs-toggle="tooltip" title="Hide Captions">
                    <img src="{{ asset('assets/images/customizer/caption-off.svg') }}" alt="Caption Off" class="toggle-preview">
              ...
              <div class="setting-control">
                <div class="image-toggle-group">
                  <button class="image-toggle active" data-value="false" onclick="layout_rtl_change('false');" data-bs-toggle="tooltip" title="Left to Right">
                    <img src="{{ asset('assets/images/customizer/ltr.svg') }}" alt="LTR" class="toggle-preview">
                  ...
                  <button class="image-toggle" data-value="true" onclick="layout_rtl_change('true');" data-bs-toggle="tooltip" title="Right to Left">
                    <img src="{{ asset('assets/images/customizer/rtl.svg') }}" alt="RTL" class="toggle-preview">
              ...
              <div class="setting-control">
                <div class="image-toggle-group">
                  <button class="image-toggle active" data-value="false" onclick="change_box_container('false')" data-bs-toggle="tooltip" title="Full Width Layout">
                    <img src="{{ asset('assets/images/customizer/full.svg') }}" alt="Full Width" class="toggle-preview">
                  ...
                  <button class="image-toggle" data-value="true" onclick="change_box_container('true')" data-bs-toggle="tooltip" title="Fixed Width Layout">
                    <img src="{{ asset('assets/images/customizer/fixed.svg') }}" alt="Fixed Width" class="toggle-preview">
