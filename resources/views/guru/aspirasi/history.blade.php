                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <i class="ph ph-map-pin"></i> {{ Str::limit($item->lokasi, 35) }}
                                </td>
                                <td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>Tanggal Selesai:</strong> {{ $item->updated_at->format('d/m/Y H:i') }}</p>
                                            @if($item->foto)
                            ...
                            <tr>
                                <td colspan="7" class="text-center">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('guru.aspirasi.index') }}" class="btn btn-primary btn-sm">
                                            <i class="ph ph-chat-circle-text"></i> Lihat Aspirasi Aktif
                                        </a>
                                    </div>
                                </td>
                            </tr>
